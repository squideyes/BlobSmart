...
{
    internal partial class Values : IServiceOperations<BlobSmartAPI>, IValues
    {
        /// <summary>
        ...
        /// </param>
        internal Values(BlobSmartAPI client)
        {
            this._client = client;
        }
        
        private BlobSmartAPI _client;
        
        /// <summary>
        /// Gets a reference to the BlobSmart.LoginTest.BlobSmartAPI.
        /// </summary>
        public BlobSmartAPI Client
        {
